        ...
        <div class="col">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
                <router-link to="/foods" class="text-dark">Petfood</router-link>
              </li>
        ...
        <div class="col-md-4">
          <form class="mt-4" v-on:submit.prevent>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" v-model="pesan.alamatPengiriman" />
            </div>
...
export default {
  ...
  methods: {
    ...
    checkout() {
      if (this.pesan.nama && this.pesan.alamatPengiriman) {
        ...
        this.$toast.error("Nama dan Alamat Pengiriman Harus diisi", {
          type: "error",
          position: "top-right",
          duration: 3000,
          dismissible: true,
